  ...
  return (
    <Transition.Root show={true} appear={true} as={Fragment}>
      <Dialog as="div" className="relative z-10" onClose={() => navigate(-1)}>
        ...
        <div
          className="overflow-y-auto fixed inset-x-0 bottom-0 w-full h-full"
          tabIndex={0}
          id="bottom-slideover"
        >
          <div className="pointer-events-none w-full h-full flex px-0 pt-28 focus:outline-none md:px-10 lg:px-20">
            <Transition.Child
              as={Fragment}
