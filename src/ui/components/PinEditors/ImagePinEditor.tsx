  ...
  return (
    <>
      <div>
        ...
        <div className="mt-2">
          <input
            ...
            onChange={(e) => pinIndex != null && setPin(parseInt(pinIndex), 1, e.target.value)}
          />
        </div>
      </div>
      ...
      <div>
        ...
        <div className="mt-2">
          <ImageMenu
            image={pins && pinIndex != null ? pins[parseInt(pinIndex)]?.[0] : ''}
            setImage={(url) => pinIndex != null && setPin(parseInt(pinIndex), 0, url)}
          />
        </div>
      </div>
